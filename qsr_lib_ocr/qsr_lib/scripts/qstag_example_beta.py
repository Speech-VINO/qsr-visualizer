...
if __name__ == "__main__":
	...
	beta_units = np.load("/home/aswin/Documents/Courses/Udacity/Intel-Edge/Work/EdgeApp/PGCR-Results-Analysis/ocr-data/beta_units.npy")
	beta = np.load("/home/aswin/Documents/Courses/Udacity/Intel-Edge/Work/EdgeApp/PGCR-Results-Analysis/ocr-data/beta.npy")
	...
	for ii,beta in tqdm(enumerate(beta)):
		o2.append(Object_State(name="o2", timestamp=timestamp[ii], x=ii, y=beta, object_type="Beta"))
