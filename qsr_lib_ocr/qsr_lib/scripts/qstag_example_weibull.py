...
if __name__ == "__main__":
	...
	weibull_units = np.load("/home/aswin/Documents/Courses/Udacity/Intel-Edge/Work/EdgeApp/PGCR-Results-Analysis/ocr-data/weibull_units.npy")
	weibull = np.load("/home/aswin/Documents/Courses/Udacity/Intel-Edge/Work/EdgeApp/PGCR-Results-Analysis/ocr-data/weibull.npy")
	...
	for ii,weib in tqdm(enumerate(weibull)):
		o2.append(Object_State(name="o2", timestamp=timestamp[ii], x=ii, y=weib, object_type="Weibull"))
	...
	if args.print_graph:
		...
		#print("QSTAG Graph:\n", qstag.graph)
		utils.graph2dot(qstag, "/home/aswin/Documents/Courses/Udacity/Intel-Edge/Work/EdgeApp/PGCR-Results-Analysis/ocr-data/graphs/weibull_graph.dot")
		os.system('dot -Tpdf /home/aswin/Documents/Courses/Udacity/Intel-Edge/Work/EdgeApp/PGCR-Results-Analysis/ocr-data/graphs/weibull_graph.dot -o /home/aswin/Documents/Courses/Udacity/Intel-Edge/Work/EdgeApp/PGCR-Results-Analysis/ocr-data/graphs/weibull_graph.pdf')
		os.system('dot -Tpng /home/aswin/Documents/Courses/Udacity/Intel-Edge/Work/EdgeApp/PGCR-Results-Analysis/ocr-data/graphs/weibull_graph.dot -o /home/aswin/Documents/Courses/Udacity/Intel-Edge/Work/EdgeApp/PGCR-Results-Analysis/ocr-data/graphs/weibull_graph.png')
